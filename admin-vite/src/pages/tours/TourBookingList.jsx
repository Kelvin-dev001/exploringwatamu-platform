...
export default function TourBookingList() {
  ...
  return (
    <div className="p-8">
      <h2 className="text-2xl font-bold mb-4">Tour Bookings</h2>
      <div className="flex flex-wrap gap-4 mb-4 items-end">
        <div>
          <label className="block text-sm">Tour:</label>
          <select className="select select-bordered w-32" value={filters.tourId} onChange={e => handleFilterChange("tourId", e.target.value)}>
        ...
        <div>
          ...
          <input type="text" className="input input-bordered w-32" value={filters.name} onChange={e => handleFilterChange("name", e.target.value)} />
        </div>
