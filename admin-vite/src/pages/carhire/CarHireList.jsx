      ...
      <div className="card bg-base-100 shadow-md mb-8 p-6">
        <div className="flex flex-wrap gap-4 items-end">
          ...
          <div>
            ...
            <input className="input input-bordered w-24" type="number" value={filters.minPrice} onChange={e => handleFilterChange("minPrice", e.target.value)} />
          </div>
          <div>
            <label className="block text-xs font-semibold mb-1">Max Price</label>
            <input className="input input-bordered w-24" type="number" value={filters.maxPrice} onChange={e => handleFilterChange("maxPrice", e.target.value)} />
          </div>
          <div>
            <label className="block text-xs font-semibold mb-1">Capacity</label>
            <input className="input input-bordered w-24" type="number" value={filters.capacity} onChange={e => handleFilterChange("capacity", e.target.value)} />
          </div>
