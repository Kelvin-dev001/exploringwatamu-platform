...
export default function EditCarHire() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-xl mx-auto bg-base-100 p-8 shadow-xl rounded">
      <h2 className="text-2xl font-bold mb-6">Edit Car Hire Option</h2>
      <div className="mb-4">
      ...
      {selectedVehicle && selectedVehicle.image && (
        <img src={selectedVehicle.image} alt={selectedVehicle.name} className="w-32 h-20 object-cover rounded mb-4" />
      )}
      <div className="mb-4">
